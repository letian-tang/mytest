 ...
 * @date 创建时间：2016年6月23日 上午8:12:50
 * @version 1.0 *
 * @since
 */
public class IdWorker2 {
	...
	private static IdWorker2 flowIdWorker2 = new IdWorker2(1);

	public static IdWorker2 getFlowIdWorker2Instance() {
		return flowIdWorker2;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		IdWorker2 idWorker2 = IdWorker2.getFlowIdWorker2Instance();
		// System.out.println(Long.toBinaryString(IdWorker2.nextId()));
